					...
					<div className="container-footer">
						<div className="flex-container">
							<div className="flex-item">
								<h1 className="footer-title">React Lite</h1>
								<p>All rights reseived</p>
							</div>
							<div className="flex-item">
								<div className="module-body">
									<ul className="list-unstyled">
										<li><a href="/sitemap/" tooltip="Карта сайта">Карта сайта</a></li>
										<li><a href="/sitemap.xml" target="_blank" tooltip="Google Sitemap">Google Sitemap</a></li>
									</ul>
								</div>
								<div className="flex-item">
									<div className="module-body">
						...
						<div className="flex-container">
							...
							<div className="flex-item">
								<div className="clearfix payment-methods">
									<ul>
										<img src="#" data-toggle="tooltip" data-placement="top" data-original-title="www.webmoney.ru" alt="" />
									</ul>
								</div>
							</div>
						</div>
